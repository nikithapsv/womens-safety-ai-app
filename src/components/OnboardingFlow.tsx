...
const I18N: Record<LanguageCode, any> = {
  en: {
    ...
    completionBody: "Liora is ready. You're in control. Stay safe.",
  ...
  hi: {
    ...
    welcomeTitle: "Liora में आपका स्वागत है",
    welcomeBody:
    ...
    privacyBody:
      "हम केवल उतना ही डेटा लेते हैं जितना फीचर्स के लिए आवश्यक है। आपकरीब अपनी सेटिंग बदल सकते हैं।",
    ...
    completionBody: "Liora तैयार है। नियंत्रण आपके पास है। सुरक्षित रहें।",
  ...
  te: {
    ...
    completionBody: "Liora సిద్ధంగా ఉంది. నియంత్రణ మీ చేతుల్లోనే. సురక్షితంగా ఉండండి.",
    startUsing: "డాష్‌బోర్డ్‌కి వెళ్లండి",
    practice: "యాక్టివేషన్ ప్రాక్టిస్",
    ...
    safeWordHint: "అనుకోకుండా చెప్పని పదబంधాన్ని ఎంచుకోండి.",
  },
}
